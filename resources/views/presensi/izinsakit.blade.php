    ...
    <div class="container-fluid">
        {{-- <div class="row mb-3">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Unggah Data</h5>
                        <form action="{{ url('importdata') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <a href="{{ url('import/template_izin.xlsx') }}" class="btn btn-secondary">Unduh Template</a>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="/presensi/izinsakit" method="GET" autocomplete="off">
                                ...
                                <div class="col-6">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" value="{{ Request('dari') }}" id="dari"
                                            class="form-control" placeholder="Dari" name="dari">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="input-icon mb-3">
                            ...
                            <div class="col-1">
                                <div class="form-group">
                                    <button type="submit" name="action" value="cetak" class="btn btn-success">
                                        <svg xmlns="http://www.w3.org/2000/svg"
