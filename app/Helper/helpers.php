...
{
    // Mengambil bagian angka dari kode terakhir (menghapus kunci dari kode terakhir)
    $angka_terakhir = intval(substr($nomor_terakhir, strlen($kunci)));

    // Menambahkan 1 ke angka terakhir untuk mendapatkan angka baru
    $angka_baru = $angka_terakhir + 1;

    // Menambahkan nol di depan angka baru sesuai dengan jumlah karakter
    $angka_baru_plus_nol = str_pad($angka_baru, $jumlah_karakter, "0", STR_PAD_LEFT);

    // Menyusun kunci dan angka baru
    $kode = $kunci . $angka_baru_plus_nol;
