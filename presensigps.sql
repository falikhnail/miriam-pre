...
CREATE TABLE IF NOT EXISTS `harilibur` (
  `kode_libur` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
('LB24001', '2024-03-12', 'IT', 'Hari Libur Puasa');
...
('0500047', 'Mela Rizki Widowati', 'HR Legal', '085641509393', NULL, 'HRD', 'HR', '$2y$10$ZzgDgNo6DZxj0/tPG3Q58eQsAr4BVRE/iahCLSk6g/C.puzHyReGC', NULL),
('1000166', 'Falikh Rifqi Nail', 'Staff IT', '085156796373', 'IT.2023-1000166.jpeg', 'IT', 'IT', '$2y$10$R49mIp229iv79jirPAVzyOFaDzkpYPgQBos0WQzMTY/vq4MvPeCAm', NULL);
